...
<div class="login-form">
    <form class="abc mt-[250px] ml-[60%] gap-5 flex flex-col w-[30%]" th:action="@{/userLogin}" th:object="${user}"
        ...
        <input type="text" th:field="*{username}"
               class="form-control username-input w-full h-[55px] border-black border-[1px] rounded-3xl bg-[#00000000] pl-6 shadow-md shadow-gray-300"
               placeholder="Tài khoản">
        <input type="password" th:field="*{password}"
               class="form-control pwd-input w-full h-[55px] border-black border-[1px] rounded-3xl bg-[#00000000] pl-6 shadow-md shadow-gray-300"
               placeholder="Mật khẩu">
        <button type="submit"
                class="login-btn bg-[#4BA9FF] flex items-center justify-center w-full h-[55px] rounded-3xl text-white font-bold text-[20px] cursor-pointer shadow-md shadow-gray-300">
            Đăng nhập
        </button>
